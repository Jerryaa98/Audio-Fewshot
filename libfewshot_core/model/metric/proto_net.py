...
class ProtoNet(MetricModel):
    def __init__(self, **kwargs):
        ...
        self.is_clap = kwargs.get('is_clap', False)
    ...
    def set_forward(self, batch, update_threshold=False, enhance_classification_via_energy=False):
        ...
        # else:
        #     feat = image
        #     support_size = self.shot_num * self.way_num
        # if False:  # enable BPA
        #     feat = BPA(distance_metric='cosine')(feat)
        # print(  "repeats in proto net:", repeats )
        # print(  "support_size in proto net:", support_size)
        # print(  "feat shape in proto net:", feat.shape )
    ...
    def set_forward_loss(self, batch):
        ...
        if not self.is_clap:
            ...
            emb = images
        if False:  # enable BPA
            emb = BPA(distance_metric='cosine')(emb)
        support_feat, query_feat, support_target, query_target, query_mask = self.split_by_episode(
            emb, mode=1
        )
